...
public class ProductsAssertionTest {
    ...
    //4)4. Check the multiple ‘Names’ in the ArrayList (Duracell - AA 1.5V CopperTop Batteries (4-Pack), Duracell - AA Batteries (8-Pack), Energizer - MAX Batteries AA (4-Pack)
    @Test
    public void test004(){
